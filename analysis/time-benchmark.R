...
bench::mark(
  ...
  train_python_stree(ctg10, "clase"),
  check = FALSE
)$median -> ctg10_run
...
bench::mark(
  ...
  train_python_stree(dermatology, "clase"),
  check = FALSE
...
bench::mark(
  ...
  train_python_stree(echocardiogram, "clase"),
  check = FALSE
...
bench::mark(
  ...
  train_python_stree(fertility, "clase"),
  check = FALSE
...
bench::mark(
  ...
  train_python_stree(ionosphere, "clase"),
  check = FALSE
...
bench::mark(
  ...
  train_python_stree(australian_credit, "clase"),
  check = FALSE
