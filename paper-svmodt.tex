...
\subsection{Example 1: Penguin Species Classification}\label{example-1-penguin-species-classification}
...
\subsubsection{Visualizing Decision Boundaries}\label{visualizing-decision-boundaries}
...
\subsubsection{Prediction Path Tracing}\label{prediction-path-tracing}
...
\subsection{Example 2: Breast Cancer Diagnosis}\label{example-2-breast-cancer-diagnosis}
...
\subsubsection{Handling Class Imbalance}\label{handling-class-imbalance}
...
\subsubsection{Feature Penalization}\label{feature-penalization}
...
\subsubsection{Dynamic Feature Selection}\label{dynamic-feature-selection}
