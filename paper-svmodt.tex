...
\begin{table}
\centering
\caption{\label{tab:table-benchmark-streer}Comparison of Mean Prediction Accuracy and Median Training Time for STreeR and STree}
\centering
...
\hline
WDBC Diagnosis & 569 & 30 & 2 & \textbf{0.970 ± 0.004} & \textbf{0.970 ± 0.003} & 0.025ms & 0.012ms\\
\hline
Iris & 150 & 4 & 3 & \textbf{0.966 ± 0.006} & 0.965 ± 0.010 & 0.011ms & 0.008ms\\
\hline
Echocardiogram & 131 & 10 & 2 & \textbf{0.846 ± 0.004} & 0.845 ± 0.008 & 0.006ms & 0.006ms\\
\hline
...
\hline
Cardiotography-3 & 2126 & 21 & 3 & 0.901 ± 0.003 & \textbf{0.903 ± 0.003} & 0.927ms & 0.241ms\\
\hline
Cardiotography-10 & 2126 & 21 & 10 & 0.763 ± 0.005 & \textbf{0.795 ± 0.018} & 4.209ms & 0.468ms\\
\hline
Ionosphere & 351 & 33 & 2 & \textbf{0.896 ± 0.009} & 0.892 ± 0.015 & 0.048ms & 0.021ms\\
\hline
Dermatology & 366 & 34 & 6 & \textbf{0.972 ± 0.006} & 0.959 ± 0.004 & 0.126ms & 0.018ms\\
\hline
Statlog Australian Credit & 690 & 14 & 2 & \textbf{0.678 ± 0.000} & \textbf{0.678 ± 0.000} & 0.032ms & 0.018ms\\
\hline
\end{tabular}
\end{table}
