...
Across nine benchmark datasets, **SVMODT** with tuned hyperparameters (SVMODT\*) consistently outperformed conventional axis-aligned CART and remained competitive with the more flexible STree\* implementation despite relying exclusively on linear node-wise hyperplanes. On Echocardiogram (0.854), Dermatology (0.979), Iris (0.971), and Fertility, it achieved the strongest or joint-strongest predictive performance among all methods considered. The untuned default configuration served as a robust baseline throughout, indicating that the proposed extensions deliver structural benefits independent of careful hyperparameter search.
